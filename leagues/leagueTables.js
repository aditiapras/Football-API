              ...
              return {
                ...
                all: cup.table.all.map((al) => {
                  return {
                    ...
                    id: al.id,
                    logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${al.id}_small.png`,
            ...
            title == "tables"
              ? {
                  ...
                  data: {
                    ...
                    logo: {
                      light: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/light/${tab.data.leagueId}.png`,
                      dark: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/dark/${tab.data.leagueId}.png`,
                    },
                    tables: run(),
                  },
                }
