              ...
              return {
                ...
                all: cup.table.all.map((al) => {
                  return {
                    ...
                    id: al.id,
                    logo: `https://api.soccerhub.pro/image_resources/logo/teamlogo/${al.id}_small.png`,
            ...
            title == "tables"
              ? {
                  ...
                  data: {
                    ...
                    logo: {
                      light: `https://api.soccerhub.pro/image_resources/logo/leaguelogo/light/${tab.data.leagueId}.png`,
                      dark: `https://api.soccerhub.pro/image_resources/logo/leaguelogo/dark/${tab.data.leagueId}.png`,
                    },
                    tables: run(),
                  },
                }
