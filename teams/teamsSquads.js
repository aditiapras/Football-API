  ...
  const getSquads = async () => {
    ...
    res.json({
      team: {
        ...
        logo: {
          normal: `https://api.soccerhub.pro/image_resources/logo/teamlogo/${squads.details.id}.png`,
          small: `https://api.soccerhub.pro/image_resources/logo/teamlogo/${squads.details.id}_small.png`,
        },
      },
      squads: returned(),
    });
