  ...
  const getSquads = async () => {
    ...
    res.json({
      team: {
        ...
        logo: {
          normal: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${squads.details.id}.png`,
          small: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${squads.details.id}_small.png`,
        },
      },
      squads: returned(),
    });
