  ...
  const getFixtures = async () => {
    ...
    const fixtures = result.allFixtures.fixtures.map((fix) => {
      return {
        ...
        opponent: {
          ...
          logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${fix.opponent.id}_small.png`,
          score: fix.opponent.score,
        },
        home: {
          id: fix.home.id,
          name: fix.home.name,
          logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${fix.home.id}_small.png`,
          score: fix.home.score,
        },
        away: {
          id: fix.away.id,
          name: fix.away.name,
          logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${fix.away.id}_small.png`,
        ...
        tournament: {
          ...
          logo: {
            light: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/light/${fix.tournament.leagueId}.png`,
            dark: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/dark/${fix.tournament.leagueId}.png`,
          },
        },
        status: fix.status,
      };
    ...
    const nextMatch = {
      ...
      opponent: {
        ...
        logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${result.allFixtures.nextMatch.opponent.id}_small.png`,
      ...
      home: {
        ...
        logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${result.allFixtures.nextMatch.home.id}_small.png`,
      ...
      away: {
        ...
        logo: `https://media.soccerhub.pro/image_resources/logo/teamlogo/${result.allFixtures.nextMatch.away.id}_small.png`,
      ...
      tournament: {
        ...
        logo: {
          light: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/light/${result.allFixtures.nextMatch.tournament.leagueId}.png`,
          dark: `https://media.soccerhub.pro/image_resources/logo/leaguelogo/dark/${result.allFixtures.nextMatch.tournament.leagueId}.png`,
        },
      },
